package com.sunshine.utils.poi;

import com.sunshine.utils.ArrayUtils;
...
public class WriteExecl {
    ...
    @SuppressWarnings("unused") private void writeChildData(String value,
        ...
        for (Map<String, Object> map : records) {
            ...
            for (String key : getArrayTitle()) {
                ...
                if (obj instanceof Integer) {
                    ...
                    value = DateUtils
                        .formateDate((Date) obj, "yyyy-mm-dd hh:mm:ss");
